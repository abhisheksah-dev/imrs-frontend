//this is a code for functionality of distance, time, fare and stops calculation
...
const startStation = prompt("Enter the source station:");
const endStation = prompt("Enter the destination station:");

// Validate user input
if (startStation == endStation) {
    console.log("Invalid input. Source and Destination can't be same .");
} else {
